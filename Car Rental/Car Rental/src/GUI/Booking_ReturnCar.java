 ...
 */
public class Booking_ReturnCar extends JFrame {

    JButton Return_Button, Cancel_Button;
    JLabel CarID_Label, CarIDValidity_Label;
    JTextField CarID_TextField;

    private Car car;

    public Booking_ReturnCar() {
        super("Return Car");
        ...
        CarID_Label = new JLabel("Enter Car ID to be Returned");
        ...
        Return_Button.setPreferredSize(new Dimension(100, 22));
        ...
        Return_Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (carID != null && car != null) {
                    setEnabled(false);
                    int showConfirmDialog = JOptionPane.showConfirmDialog(null, "You are about to Return this Car\n" + car.toString()
                            + "\n Are you sure you want to continue ??", "Return Confirmation", OK_CANCEL_OPTION);
