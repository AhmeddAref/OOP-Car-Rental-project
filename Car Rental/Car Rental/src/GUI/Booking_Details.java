...
public class Booking_Details {
    ...
    private static JButton SearchCustomerID_Button, SearchCarRegNo_Button,
            BackButton, LogoutButton, BookCar_Button, ReturnCar_Button;
    ...
    public Booking_Details() {
        ...
        MainFrame.getMainFrame().setTitle("Booking Details - Car Rental");
        ...
        ReturnCar_Button = new JButton("Return");
...
//RentPerHour,  IsRented RentDate, carOwner customer
        ...
        MainPanel.add(ReturnCar_Button, new AbsoluteConstraints(160, 625, 130, 22));
        ...
        ReturnCar_Button.addActionListener(new Booking_Details_ActionListener());
    }
    ...
    private class Booking_Details_ActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            switch (e.getActionCommand()) {
                ...
                case "Back": {
                    MainFrame.getMainFrame().setTitle("Car Rental");
                    MainMenu mm = new MainMenu();
                    MainFrame.getMainFrame().getContentPane().removeAll();
                    MainFrame.getMainFrame().add(mm.getMainPanel());
                ...
                break;
                case "Book": {
                    if (!Booking.getReturnedCars().isEmpty()) {
                        MainFrame.getMainFrame().setEnabled(false);
                        Booking_BookCar ac = new Booking_BookCar();
                        ac.setVisible(true);
                    } else {
                        JOptionPane.showMessageDialog(null, "No Returned Cars are available !");
                    }
                }
                break;
                case "Return": {
                    if (!Booking.getBookedCars().isEmpty()) {
                        MainFrame.getMainFrame().setEnabled(false);
                        Booking_ReturnCar ac = new Booking_ReturnCar();
                        ac.setVisible(true);
                    } else {
